  ...
  return (
    <div>
      ...
      <img
        ...
        alt=""
      />
      <section class="page-hero pt-16 pb-8">
        <div class="container">
          <div class="text-center">
            <ul class="breadcrumb inline-flex h-8 items-center justify-center space-x-2 rounded-3xl bg-theme-light px-4 py-2">
              ...
              <li class="leading-none text-dark">
                <span class="text-sm leading-none">/ Integration Single</span>
              </li>
            </ul>
          </div>
        </div>
              ...
              >
                <div class="px-4 text-center">
                  <img
                    ...
                    alt=""
                  />
                  <h1 class="mt-6">Webflow Integrations</h1>
                  <p class="mt-6">
                  ...
                  <a class="btn btn-primary mt-8 px-10" href="#">
                    Integrate Webflow
                  </a>
                </div>
                <div class="my-12 border-y border-border py-3">
                  <ul
                    class="tab-nav filter-list justify-center border-b-0"
                    data-tab-nav
                  >
                    <li>
                      <a
                        class="filter-btn active btn btn-sm"
                        data-tab="0"
                        href="#"
                      >
                        About Setup
                    ...
                    <li>
                      <a
                        class="filter-btn btn btn-sm inline-block border border-[#A9A9A9] text-dark"
                        data-tab="1"
                        href="#"
                      >
                        How to setup
                ...
                <div
                  class="integrations-single-content px-4 tab-content"
                  data-tab-content
                >
                  <div class="tab-content-panel" data-tab-panel="0">
                    ...
                    <p>
                      ...
                      tellus. Nulla quis lorem ut libero malesuada feugiat.
                      ...
                      accumsan tincidunt. Sed porttitor lectus nibh. Donec
                      sollicitudin molestie malesuada. Donec sollicitudin
                    </p>
                    <ul>
                      <li>
                      ...
                      <li>
                        Send emails and updates about Conclude, including news
                        and requests for agreement to amended legal documents
                        such
                      </li>
                      <li>
                    ...
                    <p>
                      ...
                      Mauris blandit aliquet elit, eget tincidunt nibh pulvinar
                      a. Nulla porttitor accumsan tincidunt. Nulla porttitor
                      accumsan tincidunt. Sed porttitor lectus nibh. Donec
                      sollicitudin molestie malesuada. Donec sollicitudin
                    </p>
                  </div>
...
export default IntergrationSingle;
