      ...
      <section class="section pt-0">
        <div class="container">
          <div class="row justify-center">
            <div class="lg:col-10">
              <ul class="integration-tab filter-list justify-center">
                <li>
                  <a
                    class="filter-btn filter-btn-active btn btn-sm"
                    data-group="all"
                    href="#"
                  >
                    All togethers
                ...
                <li>
                  <a class="filter-btn btn btn-sm" data-group="social" href="#">
                    Social media
                  </a>
                </li>
                <li>
          ...
          <div class="row mt-10 integration-tab-items">
            <div
              class="mb-8 md:col-6 lg:col-4 integration-tab-item"
              data-groups='["social"]'
            >
              <div class="rounded-xl bg-white px-10 pt-11 pb-8 shadow-lg">
                ...
                <a
                  class="inline-flex items-center font-semibold text-dark"
                  href="#"
                >
                  View integration
                  <svg
