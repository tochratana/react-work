    ...
    <div>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="mt-10 lg:col-6 lg:order-1 lg:mt-0">
              ...
              <h1>
                Connects with all your other tools to create a smooth
                experience.
              </h1>
              <p class="mt-6">
              ...
              <a class="btn btn-primary mt-6" href="#">
                Download The Theme
              </a>
            </div>
          </div>
      ...
      <section class="section features pb-0">
        <div class="container">
          ...
          <div class="mt-14 rounded-xl bg-white px-6 py-10 shadow-lg lg:px-12 lg:py-16">
            <div class="row">
                ...
                <div class="h-full rounded-lg bg-[#FAFAFA] p-6 lg:p-8">
                  ...
                  <div class="row">
                    <div class="col-6 mb-6">
                      <div class="flex flex-col items-center justify-center rounded-xl bg-white p-5 shadow-sm">
              ...
              <div class="mt-10 lg:col-6 lg:mt-0">
                <div class="mb-6 flex items-center space-x-4 rounded-lg bg-[#fafafa] px-6 py-8">
                ...
                <div class="flex items-center space-x-4 rounded-lg bg-[#fafafa] px-6 py-8">
                  <div class="relative inline-flex h-24 w-24 items-center justify-center p-3">
            ...
            <div class="mt-6 lg:col-6 lg:order-1 lg:mt-0">
              <div class="">
                ...
                <div class="mt-11 flex flex-wrap">
                  <a
                    class="btn btn-primary m-3 block w-full sm:w-auto"
                    href="#"
                  >
                    Download The Theme
                  </a>
          ...
          <div
            class="row mt-[120px] items-center"
            ...
            <div class="mt-6 lg:col-6 lg:mt-0">
              <div class="lg:max-w-[473px]" data-tab-nav>
                <div class="features-tab-item" data-tab="0">
                  ...
                  <p class="mt-4">
                    Donec sollicitudin molestie malesda. Donec sollitudin
                    molestie malesuada. Mauris pellentesque nec, egestas non
                    nisi. Cras ultricies ligula sed
                  </p>
                </div>
            ...
            <div class="lg:col-11">
              <div class="row">
                <div class="lg:col-7">
                  ...
                  <a class="btn btn-white mt-8" href="#">
                    Download The Theme
                  </a>
                </div>
