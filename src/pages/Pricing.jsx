            ...
            <div class="mt-8 md:col-6 lg:col-4 lg:mt-0">
              <div class="rounded-xl border border-primary bg-white px-8 py-10 shadow-lg lg:-mt-16">
                <div class="flex items-center justify-between">
                  ...
                  <span class="bg-gradient inline-flex h-16 w-16 items-center justify-center rounded-full">
              ...
              <div class="rounded-xl bg-white px-5 py-5 shadow-lg lg:px-10 lg:py-8">
                <div class="accordion active border-b border-border">
                  ...
                  <div class="accordion-content pl-6">
                    <p>
                      ...
                      project, and is provided "as is" with is not committed to
                      any level of service or availability of the Service.
                    </p>
                    <p>
                      If you enter into this agreement on behalf of a company,
                      you hereby agree that the company is responsible under
                      this Agreement for all actions and
                    </p>
                  </div>
                </div>
                ...
                <div class="accordion border-b border-border">
                  <div
                    ...
                    data-accordion
                  >
                    If I cancel, can I archive my designs to keep them safe come
                    back?
                    <svg
                      class="accordion-icon absolute left-0 top-[22px]"
                      x="0px"
